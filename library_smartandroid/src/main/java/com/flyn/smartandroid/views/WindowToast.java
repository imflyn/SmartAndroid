...
public class WindowToast
{
    ...
    private void show(String msg)
    {
        ...
        if (tv.getParent() == null)
        {
            ...
            params.width = DensityUtils.getScreenWidth() - DensityUtils.dip2px(32);
            params.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE | WindowManager
