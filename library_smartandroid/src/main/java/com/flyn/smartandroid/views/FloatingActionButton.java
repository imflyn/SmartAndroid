...
public class FloatingActionButton extends ImageButton
{
    ...
    {
        mColorNormal = Color.parseColor(COLOR_BG_NORMAL);
        mColorPressed = Color.parseColor(COLOR_BG_PRESS);
        mIcon = 0;
        mSize = SIZE_NORMAL;
    ...
    private void initAttributes(Context context, AttributeSet attributeSet)
    {
        ...
        if (attr != null)
        {
            try
            {
                mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal, Color.parseColor(COLOR_BG_NORMAL));
                mColorPressed = attr.getColor(R.styleable.FloatingActionButton_fab_colorPressed, Color.parseColor(COLOR_BG_PRESS));
    ...
    private void updateBackground()
    {
        ...
        LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{getResources().getDrawable(mSize == SIZE_NORMAL ? R.drawable.fab_bg_normal :
    ...
    private Drawable createStrokesDrawable(RectF circleRect)
    {
        ...
        RectF outerStrokeRect = new RectF(circleRect.left - halfStrokeWidth, circleRect.top - halfStrokeWidth, circleRect.right + halfStrokeWidth,
                circleRect.bottom + halfStrokeWidth);

        RectF innerStrokeRect = new RectF(circleRect.left + halfStrokeWidth, circleRect.top + halfStrokeWidth, circleRect.right - halfStrokeWidth,
                circleRect.bottom - halfStrokeWidth);
        ...
        paint.setShader(new LinearGradient(innerStrokeRect.centerX(), innerStrokeRect.top, innerStrokeRect.centerX(), innerStrokeRect.bottom,
                new int[]{Color.TRANSPARENT, HALF_TRANSPARENT_BLACK, Color.BLACK}, new float[]{0f, 0.8f, 1f}, TileMode.CLAMP));
